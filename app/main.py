...
class WorkbenchApp:
    ...
    def __init__(
        ...
        self.enabled_plugins = enabled_plugins or ["blog", "auth", "microblog", "about", "notes", "board", "comments", "llm_config", "topic", "nav"]
...
def cli():
    ...
    parser.add_argument("--enabled", default="blog,auth,microblog,about,notes,board,comments,llm_config,topic,nav", help="Enabled plugins (comma-separated)")
